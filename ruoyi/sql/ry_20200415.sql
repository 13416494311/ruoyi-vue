...
INSERT INTO `ry-vue`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2000', '流程管理', '0', '4', 'activiti', '', '1', 'M', '0', '0', '', 'druid', 'admin', '2020-05-11 14:43:10', 'admin', '2020-05-11 15:34:44', '');
...
INSERT INTO `ry-vue`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2027', '模型新增', '2001', '2', '', NULL, '1', 'F', '0', '0', 'activiti:model:add', '#', 'admin', '2020-05-28 14:57:22', 'admin', '2020-05-28 14:58:10', '');
INSERT INTO `ry-vue`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2028', '模型列表', '2001', '1', '', NULL, '1', 'F', '0', '0', 'activiti:model:list', '#', 'admin', '2020-05-28 14:58:02', '', NULL, '');
INSERT INTO `ry-vue`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2029', '模型修改', '2001', '3', '', NULL, '1', 'F', '0', '0', 'activiti:model:edit', '#', 'admin', '2020-05-28 14:59:26', '', NULL, '');
INSERT INTO `ry-vue`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2030', '模型删除', '2001', '4', '', NULL, '1', 'F', '0', '0', 'activiti:model:remove', '#', 'admin', '2020-05-28 14:59:55', '', NULL, '');
INSERT INTO `ry-vue`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2031', '模型导出', '2001', '5', '', NULL, '1', 'F', '0', '0', 'activiti:model:export', '#', 'admin', '2020-05-28 15:00:18', '', NULL, '');
INSERT INTO `ry-vue`.`sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `is_frame`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2032', '模型部署', '2001', '6', '', NULL, '1', 'F', '0', '0', 'activiti:model:deploy', '#', 'admin', '2020-05-28 15:00:38', '', NULL, '');
